#!/usr/bin/env python3
"""
create_excel.py — Generate input_parameters.xlsx for Expanded_Eurofer_CD.
...
PRODUCTION = [
    ...
    ('Max SIA cluster size',       'm1',     20,     50,     'SIAs'),  # Table 2
    ...
    ('Max vacancy cluster size',       'n1',     10,     20,     'vacancies'),  # Table 2
...
DIFFUSION = [
    ...
    ('Mobility cutoff',    'n_max_i', 100,    'SIAs',  None),               # Table 5

    ('Vacancy Cluster Diffusion', None, None, None, None),
    ('Size exponent',    's_vc',    1.0, '−', None),            # Table 5
    ('Mobility cutoff',  'm_max_v', 5,   'vacancies', None),    # Table 5
...
REACTIONS = [
    ...
    ('Max SIA cluster tracked',   'N',         500,    '−',      'user: 500-5000'),# Table 29
    ('Max vacancy cluster tracked','M',         500,    '−',      'user: 500-5000'),# Table 29
    ('Max He per cluster',        'L_He_max',  'mf',   '−',      'mf=mean-field'), # Table 29

    ('Size-Bin Moment Parameters (Chapter 9)', None, None, None, None),
    ('Bin ratio',             'r_ratio',       2.0,    '−',      'Eq. 188'),  # Table 33
    ('Moments per bin',       'n_moments',     2,      '−',      'zeroth + first'),
    ('Min cluster size n1',   'n1_bin',        1,      '−',      'Eq. 188'),
