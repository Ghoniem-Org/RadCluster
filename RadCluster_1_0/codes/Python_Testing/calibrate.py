#!/usr/bin/env python3
"""
calibrate.py — Autonomous parameter calibration for RadCluster_1_0.
...
def evaluate_cost(results, sim):
    ...
    if is_bin:
        from RadCluster_1_0.py_utils.bin_moment_rates import \
...
def main():
    parser = argparse.ArgumentParser(description='Calibrate RadCluster_1_0')
