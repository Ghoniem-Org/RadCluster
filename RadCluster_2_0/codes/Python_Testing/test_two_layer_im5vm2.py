"""
Stage-4 validation — the two-layer RadCluster_2_0 on the im5vm2 case.
...
ROOT = Path(r"d:/GitHub/RadCluster/RadCluster_2_0")
...
print("=" * 72)
print("Stage-4 validation: two-layer RadCluster_2_0 on the im5vm2 case")
print("=" * 72)
...
if failures:
    ...
    sys.exit(1)
print("RESULT: PASS  -- two-layer RadCluster_2_0 reproduces the im5vm2 "
