"""
simulation.py — RadCluster_2_0 simulation orchestrator.
...
class RadClusterSimulation:
    """
    Orchestrates the RadCluster_2_0 simulation workflow.
    ...
    def __init__(self, I=None, V=None, solver_mode=None,
        ...
        print("Initializing RadCluster_2_0 simulation…")
        kwargs = {}
    ...
    def _save_output_impl(self, results, solver_config):
        ...
        try:
            with open(out_dir / 'provenance.md', 'w', encoding='utf-8') as f:
                f.write(f"# RadCluster_2_0 run — {label}\n\n")
