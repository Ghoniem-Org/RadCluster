#!/usr/bin/env python3
"""
calibrate.py — Autonomous parameter calibration for RadCluster_2_1.
...
def evaluate_cost(results, sim):
    ...
    if is_bin:
        from RadCluster_2_1.py_utils.bin_moment_rates import \
...
def main():
    parser = argparse.ArgumentParser(description='Calibrate RadCluster_2_1')
