...
Usage:
  cd EuroferMicrostructure/RadCluster_2_1/codes
...
import RadCluster_2_1.py_utils.defect_production  as _dp
import RadCluster_2_1.py_utils.binding_energies   as _be
import RadCluster_2_1.py_utils.bin_moment_rates   as _bmr
import RadCluster_2_1.py_utils.input_data         as _inp
import RadCluster_2_1.py_utils.reaction_rates     as _rr
import RadCluster_2_1.py_utils.rate_equations     as _re
import RadCluster_2_1.py_utils.cpp_bridge         as _cb
import RadCluster_2_1.py_utils.post_process       as _pp
import RadCluster_2_1.py_utils.simulation         as _sim
...
def _load_run_from_dir(d, solver_mode, label):
    ...
    from RadCluster_2_1.py_utils.post_process import calculate_derived_quantities
    saved = sys.stdout, sys.stderr
    sys.stdout = sys.stderr = io.StringIO()
    try:
...
def write_report(res_dict, wall_dict, report_path):
    ...
    lines += [sep,
              ...
              f'RadCluster_2_1  —  {PHYSICS_OPTION}  —  I=V=10,000',
              sep, '']
