#!/usr/bin/env python3
"""
create_excel.py — Generate input_parameters.xlsx for RadCluster_2_1.
...
REACTIONS = [
    ...
    ('Unary direct-rotation barrier','E_a0_conv', 1.8,    'eV',  'single-loop 1/2<111>-><100> direct rotation (Marian >2 eV); sets f111(T) crossover ~350 C; calibrate to dose'),
