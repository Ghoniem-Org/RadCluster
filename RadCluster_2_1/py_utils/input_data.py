"""
input_data.py — InputData class for RadCluster_2_1.

Reads material, irradiation, and model parameters from a 5-sheet Excel
workbook (RadCluster_2_1/input/input_parameters.xlsx) and computes
...
class InputData:
    """
    Material, irradiation, and model parameters for RadCluster_2_1.
    ...
    def __init__(self, excel_file=INPUT_FILE, I=None, V=None,
        ...
        if not self.excel_file.is_file():
            raise FileNotFoundError(
                ...
                f"Run RadCluster_2_1/create_excel.py to generate it."
            )
