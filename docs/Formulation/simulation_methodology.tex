...
% Sign corrected 2026-08-16: the exponent is POSITIVE.  Loop binding INCREASES
% with size, blending to the continuum limit E_f^i; the same holds for the
% 1/2<111> branch, E_b^{111}(n) = A_111 n^{+B_111}.  The implementation
% (binding_energies.E_b_loop_100 / E_b_loop_i) has always used n^{+B}, so this
% was a typo in the manuscript, not a code/theory disagreement.
